...
public class SettingsActivity extends AppCompatActivity {
    ...
    private Button settingsButtonChangeProfileImage;
    private Button settingsButtonChangeStatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsDisplayName = (TextView) findViewById(R.id.settings_profile_name);
        settingsDisplayStatus = (TextView) findViewById(R.id.settings_profile_status);
        settingsButtonChangeProfileImage = (Button) findViewById(R.id.change_image_button);
        settingsButtonChangeStatus = (Button) findViewById(R.id.change_status_button);
        ...
        getUserDataReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(!image.equals("default_profile")){
                    Picasso.with(SettingsActivity.this).load(image).placeholder(R.drawable.user_default).into(settingsDisplayProfileImage);
                }
            }
        ...
        settingsButtonChangeProfileImage.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        settingsButtonChangeStatus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                loadingBar.setMessage("Please wait, hile we are updating your profile image...");
                loadingBar.show();
                ...
                filePath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull final Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                                        ...
                                        getUserDataReference.updateChildren(update_user_data)
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if(task.isSuccessful()){
                                                            Toast.makeText(SettingsActivity.this, "Profile image updated sucessfully...",
                            ...
                            Toast.makeText(SettingsActivity.this, "Error ocurred, while uploading your profile pic",
                                    Toast.LENGTH_SHORT).show();
